...
\subsection{School}
\cventry{2012}{Matura}{Final grade $1.2$ (with distinction)}{}{}{}
...
\cvlistitem{Extensive experience with programming in \texttt{C/C++}, \texttt{Python}, among others}
\cvlistitem{Extensive experience with parallel programming (\texttt{OpenMP, MPI, CUDA, OpenCL})}
\cvlistitem{Extensive experience in image processing (development of novel methods)}
\cvlistitem{Extensive experience with machine learning techniques and their usage}
\cvlistitem{Extensive experience with MS Office and \LaTeX}
\cvlistitem{Experience with version control software (\texttt{git, svn})}

\section{Projects}
\subsection{Acquired projects}
\cventry{03/01/2023 -- 02/28/2026}{KI4D4E}{An AI-based framework for the visualization and evaluation of massive datasets of 4D tomography for end users of beamlines}{Budget: 500k/2.5M\Euro{} (FhG/Total)}{}{}
...
\cventry{01/01/2022 -- \phantom{09/30/2025}}{MQV K7}{Quantum algorithms for application, cloud and industry}{}{}{}
\cventry{01/01/2022 -- \phantom{09/30/2025}}{Bay\@QS}{Research with applications of Quantum Computing}{}{}{}
\cventry{07/01/2022 -- \phantom{06/01/2024}}{idROX}{Creating a toolbox for multimodal data processing}{}{}{}
...
\cvitem{Institution}{Lebenshilfe M\"{u}nzkirchen}
...
\cvitem{Physics}{Passion about particle physics and fundamental research}
...
\cvitem{2023}{Co-conference chair of the 12\textsuperscript{th} Int. Conf. on Industrial Computed Tomography (iCT 2023)}
\cvitem{2023}{Chair of Best Paper Award committee at iCT 2023}
\cvitem{2023}{Organizer of the Fraunhofer EZRT Workshop on Industrial CT at the ESRF beamline BM18}
\cvitem{2023}{Talk on large 3D image processing in the annual meeting of the German Materials Society}


\vfill\makecvfoot{M\"{u}nzkirchen,~\today}
\end{document}
